      ...
      <div class="main-sidebar">
        <aside id="sidebar-wrapper">
          ...
          <div class="sidebar-brand sidebar-brand-sm">
            <a href="<?php echo e(url('/pedagang')); ?>">Klp</a>
          </div>
            ...
            <li class="menu-header">Dashboard</li>
              <li class="nav-item dropdown active">
                ...
                <ul class="dropdown-menu">
                  <li <?php echo $__env->yieldContent('active'); ?>><a href="<?php echo e(url('/pedagang')); ?>">Pedagang Besar</a></li>
                  <li <?php echo $__env->yieldContent('active2'); ?>><a href="<?php echo e(url('/sopir')); ?>">Sopir</a></li>
                </ul>
              </li>
            </ul>
          </aside>
...
<?php /**PATH E:\Kuliah\Semester 5\kelapa\resources\views/layouts/master.blade.php ENDPATH**/ ?>