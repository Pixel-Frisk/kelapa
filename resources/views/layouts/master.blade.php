                ...
                <ul class="sidebar-menu">
                  <li class="menu-header">Dashboard</li>
                    <li class="nav-item dropdown @yield('drop')">
                      <a href="#" class="nav-link has-dropdown"><i class="far fa-user"></i> <span>Users</span></a>
                      <ul class="dropdown-menu">
                        <li @yield('active')><a href="/profile/{{auth()->user()->id}}">Pedagang Besar</a></li>
                        <li @yield('active2')><a href="/sop/{{auth()->user()->id}}">Sopir</a></li>
                      </ul>
                    </li>
                  </ul>
                </aside>
                ...
                <ul class="sidebar-menu">
                  <li class="menu-header">Dashboard</li>
                    <li class="nav-item dropdown @yield('drop')">
                      <a href="#" class="nav-link has-dropdown"><i class="far fa-user"></i> <span>Users</span></a>
                      <ul class="dropdown-menu">
                        <li @yield('active')><a href="/ped/{{auth()->user()->id}}">Pedagang Besar</a></li>
                        <li @yield('active2')><a href="/profile/{{auth()->user()->id}}">Sopir</a></li>
                      </ul>
                    </li>
                  </ul>
                </aside>
