    ...
    <div class="section-header">
      ...
      <div class="row mt-sm-4">
        <div class="col-12 col-md-12 col-lg-7">
          <div class="card">
            <form action="/updateTransaksi/{{$transaksi->idTransaksi}}" method="post">
              @csrf
              ...
              <div class="card-body">
                  <div class="row">
                    <div class="form-group col-md-6 col-12">
                      <label>Tanggal</label>
                      <input name="tanggal" type="datetime" class="form-control" value="{{$transaksi->tanggal}}" required>
                    </div>
                    <div class="form-group col-md-6 col-12">
                      <label>No</label>
                    ...
                    <div class="form-group col-md-6 col-12">
                      ...
                      <input name="namaPenjual" type="text" class="form-control" value="{{$transaksi->namaPenjual}}" required>
                    </div>
                    @endif
                    @if($transaksi->faktur == 'Pemasukan')
                    <div class="form-group col-md-6 col-12">
                      <label>Nama Supplier</label>
                      <input name="namaSupplier" type="text" class="form-control" value="{{$transaksi->namaSupplier}}" required>
                    </div>
                    @endif
                    <div class="form-group col-md-6 col-12">
                      <label>Quantity</label>
                      <input name="quantity" type="number" class="form-control" value="{{$transaksi->quantity}}" required>
                    </div>
                    <div class="form-group col-md-6 col-12">
                      <label>Harga</label>
                      <input name="harga" type="number" class="form-control" value="{{$transaksi->harga}}" required>
                    </div>
                    @if($transaksi->faktur == 'Pemasukan')
                    <div class="form-group col-md-6 col-12">
                    ...
                    <div class="form-group col-md-6 col-12">
                      <label>Status</label>
                      <input name="keterangan" type="text" class="form-control" value="{{$transaksi->keterangan}}" required>
                    </div>
                  </div>
              </div>
